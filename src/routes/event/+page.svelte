...
<div class="bg-white py-6 sm:py-8 lg:py-12">
    <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
      ...
      <div class="mb-10 md:mb-16">
        <p class="max-w-screen-md text-gray-500 md:text-lg text-center mx-auto">To foster the spirit of entrepreneurship and business acumen among the students, it accelerates the journey from an innovative idea to a commercial success by means of a myriad of competitions, hands-on workshops and one-on-one mentoring.

          E-Cell VPPCOE strives to be at the forefront by creating networking and funding opportunities for students startups while grooming and nurturing them.</p>
        <h2 class="text-gray-800 text-2xl lg:text-3xl font-bold text-center mb-4 md:mb-6">Upcoming Events</h2>
  ...
  <div class="bg-white py-6 sm:py-8 lg:py-12">
    <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
      <!-- text - start -->
      <div class="mb-10 md:mb-16">
        <h2 class="text-gray-800 text-2xl lg:text-3xl font-bold text-center mb-4 md:mb-6">Past Events</h2>
      </div>
      <!-- text - end -->
      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6 xl:gap-8">
        ...
        <a href="#" class="group h-48 md:h-64 xl:h-96 flex flex-col bg-gray-100 rounded-lg shadow-lg overflow-hidden relative">
          ...
          <div class="relative p-4 mt-auto">
            <span class="block text-gray-200 text-sm">July 19, 2021</span>
            <h2 class="text-white text-xl font-semibold transition duration-100 mb-2">FFFFFFufiiiiiiii</h2>
